...
def download_files():
  urllib.request.urlretrieve("https://storage.googleapis.com/ml-lab-152505-ml/train.from", "train.from")
  urllib.request.urlretrieve("https://storage.googleapis.com/ml-lab-152505-ml/train.to", "train.to")
